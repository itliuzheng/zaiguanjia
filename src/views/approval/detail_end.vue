<template>
  <div class="main">
    ...
    <div>
      ...
      <div class="approval-box" v-if="data.status == 4">
        <div>
    ...
    <el-dialog :title="data.title"
      ...
      <el-form :model="dialogForms" ref="dialogForms"
        ...
        <el-form-item label="" >
          <el-radio v-model="dialogForms.status" label="6">通过</el-radio>
          <el-radio v-model="dialogForms.status" label="5">拒绝</el-radio>
        </el-form-item>
        <div v-if="dialogForms.status == 4">
          <el-form-item label="授信额度（元）">
            <el-input v-model="dialogForms.creditAccount"></el-input>
          </el-form-item>
          <el-form-item label="授信期限">
            <el-select v-model="dialogForms.creditPeriod">
        ...
        new Promise((resolve,reject) => {
          ajax({
            ...
            data:{
              ...
              creditAccount:_this.dialogForms.creditAccount,
              creditPeriod:_this.dialogForms.creditPeriod,
            }
          }).then(function (res) {
            let date = res.data;
            if(date.code == 1){
